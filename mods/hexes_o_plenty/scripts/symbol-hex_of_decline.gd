...
func _init():
    mod_type = "symbol"
    type = "hexes_o_plenty.hex_of_decline"
    display_name = "Hex of Decay"
    value = 6
    description = "Has a <color_E14A68><value_1>%<end> chance to <color_E14A68>permanently<end> give <color_FBF236><icon_coin>1<end> <color_E14A68>less<end>."
    values = [30, 1]
    rarity = "uncommon"
    ...
    value_text = {
        "color": "symbol_reminder_down_text",
        "value": {
            "starting_value": "permanent_bonus",
            "var_math": [
                {
                    "*": -1
                }
