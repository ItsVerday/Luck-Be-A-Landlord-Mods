...
func _init():
    mod_type = "symbol"
    type = "hexes_o_plenty.hex_of_hexing"
    display_name = "Hex of Hexing"
    value = 3
    description = "Has a <color_E14A68><value_1>%<end> chance of <color_E14A68>adding<end> <group_hex> or <last_hex>."
    values = [30]
    rarity = "uncommon"
