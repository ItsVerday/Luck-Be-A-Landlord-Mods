...
func _init():
    mod_type = "symbol"
    type = "hexes_o_plenty.hex_of_cloning"
    display_name = "Hex of Cloning"
    value = 3
    description = "Has a <color_E14A68><value_1>%<end> chance of <color_E14A68>adding<end> <icon_hexes_o_plenty.hex_of_cloning>."
    values = [6]
    rarity = "uncommon"
